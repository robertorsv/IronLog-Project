...
const { bodyParts, selectedCategory } = storeToRefs(store)
  ...
  <div class="w-full overflow-x-auto pb-4 mb-6 custom-scrollbar">
    <div class="flex space-x-4 px-2">
      <button
        ...
        :key="part"
        @click="store.selectCategory(part)"
        ...
        :class="[
          selectedCategory === part 
            ? 'bg-primary text-black border-primary shadow-[0_0_15px_rgba(224,93,38,0.4)]' 
            : 'bg-surface text-gray-400 border-gray-700 hover:border-primary hover:text-white'
        ]"
      >
        {{ part }}
      </button>
